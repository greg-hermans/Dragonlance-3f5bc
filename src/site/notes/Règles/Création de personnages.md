...
En conclusion, ces classes ont été progressivement abandonnée et sont donc devenues très rares et donc **très peu recommandées pour les PJ**. (Sauf si vous êtes prêts à jouer une classe beaucoup plus faible que les autres.).
